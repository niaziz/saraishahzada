...
function sidebarColor(a) {
  ...
  if (document.querySelector('#sidenavCard')) {
    ...
    let sidenavCardClasses = [ 'text-white' ,'bg-gradient-' + color];
    sidenavCard.className = 'sidenav bg-white navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-4 ps ps--active-y';
